...
namespace FitnessClubManagement
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //services.AddPaging();
            //To Use InMemory Db
            services.AddDbContext<FitnessClubDbContext>(options => options.UseInMemoryDatabase(databaseName: "InmemeoryAppConn"));
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env)
        {
            ...
            app.UseMvc(routes =>
            {
                routes.MapRoute(
                    name: "default",
                    template: "{controller=Fitness}/{action=Index}/{id?}");
            });
        }
    }
}
